...
void main() {
  ...
  test(
    ...
    () async {
      ...
      await clockAction(() => engine.startJam());
      await waitUntil(
        () => state.team1.serverId.isNotEmpty && state.team2.serverId.isNotEmpty,
        timeout: const Duration(seconds: 20),
      ...
      await waitUntil(
        ...
        label: 'official review owner becomes team 1 and its count decrements',
        debugState: state,
      );
      ...
      await waitUntil(
        ...
        label: 'official review owner becomes team 2 and its count decrements',
        debugState: state,
      );
